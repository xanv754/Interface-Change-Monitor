...
from data.schemas.assignment import ASSIGNMENT_SCHEMA
from data.schemas.interface import INTERFACE_SCHEMA
from data.schemas.change import CHANGE_SCHEMA
from data.schemas.user import USER_SCHEMA
