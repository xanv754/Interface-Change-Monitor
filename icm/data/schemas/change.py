...
CHANGE_SCHEMA = f"""
    CREATE TABLE IF NOT EXISTS {TableNames.CHANGES} (
        ...
        {ChangeField.IFHIGHSPEED_OLD} NUMERIC NULL,
        ...
        {ChangeField.IFHIGHSPEED_NEW} NUMERIC NULL,
        {ChangeField.IFOPERSTATUS_NEW} VARCHAR(20) NULL,
        {ChangeField.IFADMINSTATUS_NEW} VARCHAR(20) NULL,
