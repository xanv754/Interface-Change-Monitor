...
export class ExportHandler {
    static async exportHistoryUserToExcel(
        username: string,
        ...
        try {
            ...
            interfaces.forEach((assignment) => {
                ...
                if (assignment.type_status === AssignmentStatusTypes.PENDING)
                    statusTranslation = "Pendiente";
                else if (assignment.type_status === AssignmentStatusTypes.INSPECTED)
                    statusTranslation = "Revisado";
                else if (assignment.type_status === AssignmentStatusTypes.REDISCOVERED)
                    statusTranslation = "Revisado (Interfaz Redescubierta)";
                else if (
                    assignment.type_status === AssignmentStatusTypes.EQUIPMENT_DOWN
                )
                    statusTranslation = "Equipo Caído";
                worksheet.addRow({
    ...
    static async exportInterfaceChangesToExcel(
