...
class SNMP:
    ...
    def _get_value(self, value: str) -> str:
        """Get the value real of the status."""
        if "(" in value:
    ...
    def get_consults(self) -> bool:
        ...
        try:
            data: List[InterfaceRegisterBody] = []
                    ...
                    with open(self.folderpath + "/" + file, "r") as file:
                        for line in file:
                            ...
                            if line:
                                ...
                                ifOperStatus = self._get_value(line.split(";")[5].strip())
                                ifAdminStatus = self._get_value(line.split(";")[6].strip())
