...
from database.schemas.assignment import ASSIGNMENT_SCHEMA
from database.schemas.interface import INTERFACE_SCHEMA
from database.schemas.change import CHANGE_SCHEMA
